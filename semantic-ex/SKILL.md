...
生成したfakeデータは以下のパスに保存する：

- **スタンドアロン使用時**: `story/fake-data-50.json`
- **be-semantic ワークフロー内で使用時**: `design/fake/data-50.json`（be-semantic の作業ディレクトリに合わせる）
...
- **スタンドアロン使用時**: `story/fake-data.md`
- **be-semantic ワークフロー内で使用時**: `design/fake/constraints.md`
...
- **スタンドアロン使用時**: `schema/[state-name].json`
- **be-semantic ワークフロー内で使用時**: `design/schema/[state-name].json`
